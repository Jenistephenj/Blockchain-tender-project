...
import 'package:tender/department/DepartmentHome.dart';
...
import 'DepartmentViewExpenses.dart';


class DepartmentViewAllotTenders extends StatefulWidget {
  @override
  _VieweefeTendersState createState() => _VieweefeTendersState();
}

class _VieweefeTendersState extends State<DepartmentViewAllotTenders> {
                            ...
                            if (contractorSnapshot.connectionState ==
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    CircularProgressIndicator(
                                        color: Colors.blueGrey[900], strokeWidth: 2),
                                    SizedBox(width: 16),
                              ...
                              children: [
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: Colors.blueGrey[300]!, width: 2),
                                  ),
                                  child: IconButton(
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => ContractorViewExpenses(
                                            tenderId: itemId,
