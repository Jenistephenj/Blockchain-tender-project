...
import 'DepartmentViewBidding.dart';

class DepartmentViewTenders extends StatefulWidget {
  @override
  _VieweefeTendersState createState() => _VieweefeTendersState();
}

class _VieweefeTendersState extends State<DepartmentViewTenders> {
                              ...
                              child: IconButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DepartmentViewBidding(
                                        tenderId: itemId,
                                ...
                                icon: Icon(Icons.gavel, color: Colors.blueGrey[900]),
